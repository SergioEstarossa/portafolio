...
import imagenPrincipal from 'common/assets/image/portfolio/development.jpg';
  ...
  return (
    <BannerWrapper id="banner_section">
      <Container noGutter mobileGutter width="1200px">
        <Box {...row}>
          <Box {...contentArea}>
            <Heading content="Sergio Méndez" {...nameStyle} />
            <Box {...roleWrapper}>
              <Icon
                ...
                size={22}
              />
              <Heading content="Desarrollador de Software" {...roleStyle} />
            </Box>
            <Text
              content=""
              {...aboutStyle}
          ...
          <Box {...imageArea} className="image_area">
            <NextImage src={imagenPrincipal} alt="Mat Helme" />
          </Box>
        </Box>
      </Container>
    </BannerWrapper>
